...
export const venues = {
  ...
  att: {
    ...
    transit: [
      "TRE CentrePort Station + Shuttle",
      "DART Orange Line to CentrePort",
    ],
  ...
  levis: {
    ...
    transit: [
      "VTA Light Rail to Great America",
      "Caltrain to Santa Clara + Shuttle",
    ],
  ...
  mercedesbenz: {
    ...
    transit: [
      "MARTA Vine City Station (0.3 mi walk)",
  ...
  gillette: {
    ...
    transit: [
      "MBTA Commuter Rail event service from Boston",
      "Shuttle from Patriot Place",
    ],
  ...
  bmo: {
    ...
    transit: [
      "TTC Line 1 to Union + Streetcar 509/511",
...
export const matches = [
  ...
  },
  {
    ...
    scoreB: 1,
    status: "completed",
    note: "Switzerland wins 4-2 on penalties",
  },
  {
    id: "R16-6",
    round: "Round of 16",
...
export const trafficConditions = {
  metlife: [
    ...
    {
      road: "NJ Route 3 (Westbound)",
      status: "moderate",
      delay: 12,
      color: "warning",
    },
    {
      road: "I-95 / NJ Turnpike",
      status: "moderate",
      delay: 15,
      color: "warning",
    },
...
/**
 * Retrieves the full match object for a given match ID.
 *
 * @param {string} matchId - The match ID (e.g., 'GS-01')
...
/**
 * Returns UI display configuration for a given match based on its status.
 *
 * @param {Object} match - The match object
 * @returns {Object} An object containing the display label and UI color token
 */
...
/**
 * Formats a date string (YYYY-MM-DD) into a human-readable "DD MMM YYYY" format.
 *
