...
/**
 * Fetches real-time live weather data for a given venue.
 * Implements caching (15 min) and fallback telemetry if offline.
 *
 * @param {string} venueId - The unique identifier of the venue (e.g., 'metlife')
 * @returns {Promise<Object>} An object containing temperature, humidity, condition, and status.
 */
export async function fetchLiveWeather(venueId) {
  ...
  try {
    ...
    console.warn(
      "Live weather fetch failed, returning high-accuracy telemetry fallback:",
      error,
    );
