...
describe('Header Component', () => {
  it('renders the stadium name or location correctly', () => {
    render(<Header selectedVenueId="metlife" onOpenCheckIn={() => {}} onToggleSidebar={() => {}} />);
  ...
  it('renders standard title when not in ops mode', () => {
    render(<Header selectedVenueId="metlife" onOpenCheckIn={() => {}} onToggleSidebar={() => {}} activeSection="home" />);
