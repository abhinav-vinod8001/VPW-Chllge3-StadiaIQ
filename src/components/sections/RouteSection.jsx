  ...
  const transportOptions = [
    {
      ...
      notes:
        "Not recommended due to heavy post-match egress. Lot K parking requires pre-booked QR permit.",
    },
    {
      id: "rail",
      ...
      cost: "$5.50 One-Way",
      notes:
        "Trains running every 4 minutes directly from concourse Gate 4. Zero road traffic delay.",
    },
    {
      id: "shuttle",
      ...
      notes:
        "Dedicated bus lanes from Secaucus Junction and Fan Festival Hubs.",
    },
    {
      id: "rideshare",
      name: "Rideshare / Taxi",
    ...
    <div className="section active">
      <div className="section__header">
        <h2 className="section__title">
          <Navigation style={{ color: "var(--color-primary-light)" }} /> Route
          Navigation & Live Traffic Telemetry
        </h2>
        <p className="section__description">
          Real-time multimodal navigation and road congestion monitoring for all
          16 FIFA World Cup 2026™ host stadiums across the United States,
          Mexico, and Canada.
        </p>
      </div>
      ...
      <div className="card" style={{ marginBottom: "var(--space-6)" }}>
        <div className="card__header">
          <span className="card__title">
            📍 Select Host Stadium & Departure Origin
          </span>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                OPEN-METEO LIVE ({venue.city.split(",")[0].toUpperCase()})
              </div>
              <div
                style={{
                  fontSize: "1.1rem",
              ...
              <div style={{ fontSize: "0.68rem", opacity: 0.85 }}>
                Wind: {weather.windSpeed} km/h • Humidity:{" "}
                {weather.humidity || 58}%
              </div>
            </div>
          </div>
      ...
      <div className="content-grid" style={{ marginBottom: "var(--space-6)" }}>
        <div className="card">
          <div className="card__header">
            <span className="card__title">
              🗺️ Live OpenStreetMap Telemetry View
            </span>
            <a
          ...
          <div className="card__body card__body--flush">
            ...
            >
              ...
              >
                📍 GPS Coordinates: {venue.lat.toFixed(4)}° N,{" "}
                {venue.lng.toFixed(4)}° W
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="card__header">
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              <span className="card__title">
                🚨 Real-Time Road & Corridor Alerts
              </span>
          ...
          >
            {telemetry.liveAlerts.map((alt, idx) => (
              <div
                key={idx}
                className={`alert alert--${alt.color}`}
              ...
              >
                ...
                <div style={{ fontSize: "0.8rem", marginTop: "0.3rem" }}>
                  <strong>
                    {alt.status.toUpperCase()} CONGESTION (+{alt.delay} min
                    delay)
                  </strong>{" "}
                  — DOT cameras report heavy pre/post-match traffic volume near
                  gate approach.
                </div>
                <div
                  style={{
                ...
                >
                  Reported at {alt.time} • AI Recommendation: Re-route via
                  secondary transit corridors or board rail express.
                </div>
              </div>
            ))}
            ...
            >
              ...
              <div className="alert__content">
                ...
                Express Rail corridors are operating at 100% on-time frequency
                (`every 4 mins`) with zero road congestion impact.
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="card">
        <div className="card__header">
          <span className="card__title">
            ⚡ Multimodal Journey Comparison (`{userLocation}` → `{venue.name}`)
          </span>
          <span className="badge badge--success">
            AI Recommended: Express Rail
          </span>
        </div>
        <div className="card__body card__body--flush">
