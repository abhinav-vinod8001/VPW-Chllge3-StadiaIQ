...
export default function StadiumMapSection() {
  ...
  const doSearch = () => {
    ...
    for (const s of sectionDefs) {
      if (
        s.id.toLowerCase().replace(/\s+/g, "") === q ||
    ...
    <div className="section active">
      <div className="section__header">
        <h2 className="section__title">
          <Compass style={{ color: "var(--color-primary-light)" }} />{" "}
          Interactive Rectangular Stadium Seating Map
        </h2>
        <p className="section__description">
          Click any seating section to view exact tier details, view category
          classifications, or search in natural language for gates, medical
            ...
            <div style={{ marginTop: "1rem" }}>
                ...
                <div className="alert alert--success">
                  ...
                  <div className="alert__content">
                    <div className="alert__title">
                      Highlighted: Section {searchResult.data.id}
                    </div>
                    <div>
                      {searchResult.data.tier} Tier • {searchResult.data.stand}{" "}
                      Stand • {searchResult.data.type} Seating Category
                    </div>
                  </div>
                </div>
              )}
              {searchResult.type === "poi" && (
                <div className="alert alert--info">
                  ...
                  <div className="alert__content">
                    <div className="alert__title">
                      Found Point of Interest: {searchResult.data.label}
                    </div>
                    <div>
                      Located on the stadium perimeter ring above. Check the{" "}
                      {searchResult.data.id.includes("n")
                        ? "North"
                        : searchResult.data.id.includes("s")
                          ? "South"
                          : "Side"}{" "}
                      concourse.
                    </div>
              ...
              {searchResult.type === "ai" && (
                <div className="alert alert--info">
                  ...
                  <div className="alert__content">
                    <div className="alert__title">
                      StadiaIQ Wayfinding Response
                    </div>
                    <div style={{ whiteSpace: "pre-line", marginTop: "4px" }}>
                      {searchResult.text.replace(/\*\*(.*?)\*\*/g, "$1")}
                    </div>
                  </div>
                </div>
              )}
