  ...
  const languages = [
    {
      ...
      flag: "🇺🇸",
      name: "English",
      desc: "Default Match-Day Experience",
    },
    {
      code: "es",
      flag: "🇲🇽",
      name: "Español",
      desc: "Experiencia Oficial FIFA en Español",
    },
    {
      code: "fr",
      flag: "🇫🇷",
      name: "Français",
      desc: "Assistance IA & Guide en Français",
    },
    {
      code: "pt",
      flag: "🇧🇷",
      name: "Português",
      desc: "Navegação e Suporte em Português",
    },
  ];
    ...
    >
      ...
      >
        ...
        <div
          style={{
            background:
              "linear-gradient(135deg, #1e3a8a 0%, #2563eb 55%, #0f172a 100%)",
        ...
        >
          ...
          >
            Select your match and we'll auto-configure the venue, weather
            telemetry, routes, and crowd monitoring for you.
          </p>
          <div
            style={{
              display: "flex",
        ...
        >
          ...
          <div>
            ...
            >
              <Trophy size={15} style={{ color: "#f59e0b" }} /> 1. Which Match
              Are You Attending?
            </label>
            ...
            {todaysMatches.length > 0 && (
              ...
              >
                ...
                ></span>
                {todaysMatches.filter((m) => m.status === "live").length > 0
                  ? "LIVE MATCHES TODAY"
                  : "MATCHES TODAY"}{" "}
                — {todayStr.split(",")[0]}
              </div>
              ...
              {availableMatches.map((match) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      style={{ flex: 1, paddingLeft: isLive ? "0.5rem" : 0 }}
                    >
                      <div
                        style={{
                          display: "flex",
                      ...
                      >
                        ...
                        <span
                          className={`badge badge--${statusDisplay.color}`}
            ...
            {selectedVenue && (
              ...
              >
                ...
                />
                <span>
                  <strong>Auto-configured:</strong> Weather, routes, crowd
                  monitoring, and AI wayfinding will be set to{" "}
          ...
          >
            ...
            {!isStaff ? (
              ...
              >
                ...
                >
                  <strong>Staff Mode:</strong> Full access to Operations Triage,
                  PA Broadcasts, and Crowd Control dashboards.
                </div>
              </div>
            )}
          </div>
